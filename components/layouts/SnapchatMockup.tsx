...
import { Camera, Send, MessageSquare, Heart, Download, User, Image as ImageIcon } from 'lucide-react';

const SnapchatMockup: React.FC<{ postData: PostData }> = ({ postData }) => {
  return (
    <div className="w-full max-w-[350px] aspect-[9/16] rounded-[2.5rem] md:rounded-[3rem] border-6 md:border-8 border-black shadow-2xl relative overflow-hidden bg-black flex items-center justify-center">
      ...
      <div className="absolute inset-0 flex flex-col justify-between p-4 md:p-6 bg-gradient-to-b from-black/40 via-transparent to-black/60 pointer-events-none">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
             <div className="w-9 h-9 md:w-10 md:h-10 rounded-full border-2 border-yellow-400 overflow-hidden shrink-0 flex items-center justify-center bg-zinc-900">
